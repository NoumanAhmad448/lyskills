                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                    <video width="500" height="240" controls preload="auto" oncontextmenu="return false;">
                                                        <source src="{{asset('storage/'.$media->lec_name) ?? ''}} " type="{{$media->f_mimetype ?? ''}}">
                                                    </video>
                                            ...
                                            <div class="col-md-9">
                                                <div class="d-flex">
                                                    <video width="500" height="240" controls oncontextmenu="return false;">                                                        
                                                        ...
                                                        <source src="{{asset('storage')}}/{{$vid_path}}" type="{{$res->f_mimetype}}">
                                                    </video>                                                    
                                                </div>
                                                <section class="mt-2">
        ...
        $(function() {
            ...
            $( "#add_sec" ).click(function() {
                ...
                if (typeof sec !== 'undefined') {
                    ...
                    sec.before(`<div class="bg-light font-weight-bold p-3 section mt-2 border">
                        <section>
                            <div>
                                <div class="row">
            ...
            $(".sec-container").on("click", '.sec_title_edit',function(){
                ...
                parent.replaceWith( `<form class="section_title_form">
                     <input type="text" class="form-control d-inline-block" required placeholder="Section Title" value="${parent_text}" >
                ...
                .done(function(d) {
                    ...
                    if(d.hasOwnProperty('status')){
                        ...
                        if(d.hasOwnProperty('sec_title')){  
                            ...
                            returned_title = reduceTextLen(returned_title);
            ...
            $('.sec-container').on('click', '.add_title', function() {
                ...
                current_elem.replaceWith( `<form class="section_title_form">
                     <input type="text" class="form-control d-inline-block" required placeholder="Section Title" value="" >
                     <div class="alert alert-danger d-none mt-1 err_msg">  </div>
                     <div class="d-flex justify-content-end mt-1">
