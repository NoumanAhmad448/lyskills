                    ...
                    <div class="col-md-6">
                        <select class="js-example-responsive js-states form-control" id="select_level" name="select_level">
                            ...
                            <option value="intermediate" @if ($c_level === 'intermediate') {{ __('selected') }} @endif>
                                Intermediate </option>
                            <option value="advance" @if ($c_level === 'advance') {{ __('selected') }} @endif> Advance
                            </option>
                            <option value="all_level" @if ($c_level === 'all_level') {{ __('selected') }} @endif> All
                                level
                            </option>
                        </select>
                            ...
                            @if (isset($categories) && $categories)
                                @foreach ($categories as $c)
                                    <option value="{{ $c->value ?? null }}"
                                        @if ($c_category === $c->value) {{ __('selected') }} @endif>
                                        {{ $c->name ?? null }} </option>
                                @endforeach
                            @endif
                        </select>
        ...
        <section class="course_vid my-5">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    @else
                        <img src="{{ asset('img/thumbnail.jpg') }}" alt="Course Thumbnail" class="img-fluid video_img"
