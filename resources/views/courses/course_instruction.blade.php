                ...
                <div class="text-center">
                    ...
                    <section class="row">
                        <div class="col-md-4 offset-md-2 bg-white">
                            <div>
                                <div
                                    class=" p1  jumbotron bg-white @if ($course_type === 'course') {{ __('text-primary') }} @endif">
                        ...
                        <div class="col-md-4 bg-white ml-md-3">
                            <div class="">
                                ...
                                <div
                                    class="p2 jumbotron bg-white @if ($course_type === 'practice') {{ __('text-primary') }} @endif">
            ...
            <div class="col-sm">
                <div class="d-flex justify-content-end">
                    ...
                    <form action="{{ route('courses_instructions', ['id' => $id, 'course_id' => $course_id]) }}"
                        ...
                        @csrf
                        <div class="form-check">
                            <input type="hidden" value="@if ($course_type === 'practice') {{ __('practice') }} @endif"
                                name="practice" id="practice">
                        </div>

                        <div class="form-check">
                            <input type="hidden" value="@if ($course_type === 'course') {{ __('course') }} @endif"
...
@section('course_footer')
    <script src="{{ asset('js/course_instruction.js') }}"></script>
@endsection
