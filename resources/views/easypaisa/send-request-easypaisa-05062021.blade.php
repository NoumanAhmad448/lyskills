...
<!--<form action="https://easypaystg.easypaisa.com.pk/tpg" method="get" name="myForm">-->
<!--<form action="{{route('get-token-pay')}}" method="post" name="myForm">-->
    <!--@csrf-->
    ...
    <input type="hidden" id="orderId" name="orderId" value="abc123">
...
//             postBackURL:callBackURL,timeStamp: timeStamp};
            ...
            // const keyBuffer = aesjs.utils.utf8.toBytes(encryptedHashRequest);
