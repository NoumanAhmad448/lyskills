                    ...
                    <div class="form-group d-flex align-items-center">
                        ...
                        <select class="custom-select custom-select mb-3" id="sorting" name="sorting">
                            ...
                            <option value="ai" @if ($order === 'ai') {{ __('selected') }} @endif>Ascending
                                by ID</option>
                            <option value="di" @if ($order === 'di') {{ __('selected') }} @endif>Descending
                                by ID</option>
                            <option value="an" @if ($order === 'an') {{ __('selected') }} @endif>Ascending
                                by Name</option>
                            <option value="dn" @if ($order === 'dn') {{ __('selected') }} @endif>Descending
                                by Name</option>
                            <option value="ae" @if ($order === 'ae') {{ __('selected') }} @endif>Ascending
                                by Email</option>
                            <option value="de" @if ($order === 'de') {{ __('selected') }} @endif>Descending
                                by Email</option>
                        </select>
                    </div>
                </form>
