...
@section('page-css')
    ...
    <meta property="og:image"         content="@if(empty($c_img))  {{asset('img/logo.jpg')}}  {{ asset('storage/'.$c_img) }} @endif" />
@endsection
                ...
                <div class="border p-1">
                    ...
                    @if($c_vid && $c_vid->vid_path)                    
                        <video  controls class="w-100">
                            <source src="{{'https://lyskills-by-nouman.s3.ap-southeast-1.amazonaws.com/'}}{{ $c_vid->vid_path }}" type="{{$c_vid->video_type ?? '' }}">                        
