<x-guest-layout>
    ...
    <x-jet-authentication-card>
        ...
        <a href="{{ route('google-login') }}" class="btn btn-info btn-lg  my-1 d-block" style="width: 25rem"> <i class="fa fa-google" aria-hidden="true"></i>
            Sign Up With Google 
        </a>
        <a href="{{ route('fb-login') }}" class="btn btn-info btn-lg  my-1 d-block" style="width: 25rem"> <i class="fa fa-facebook" aria-hidden="true"></i>

            Sign Up With Facebook 
        </a>
        <a href="{{ route('li-login') }}" class="btn btn-info btn-lg  my-1 d-block" style="width: 25rem"> <i class="fa fa-linkedin" aria-hidden="true"></i>            
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-check mt-3">
                <input class="form-check-input" type="checkbox" value="{{old('terms')}}" id="terms" name="terms">
