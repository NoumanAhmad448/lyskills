    ...
    <div class="flex flex-1 justify-between items-center">
        <div class="flex flex-col mx-3">
            ...
            <select id="sale" name="sale" class="border-0 focus:ring-0">
                ...
                <option {{ request('sale') == '2' ? 'selected="selected"' : '' }} value="2">{{ __('Rent') }}
                </option>
                <option {{ request('sale') == '1' ? 'selected="selected"' : '' }} value="1">{{ __('Sale') }}
                </option>
            </select>
        </div>
        ...
        <div class="flex flex-col mx-3">
            ...
            <select id="type" name="type" class="border-0 focus:ring-0">
                ...
                <option {{ request('type') == '3' ? 'selected="selected"' : '' }} value="3">{{ __('Land') }}
                </option>
                <option {{ request('type') == '1' ? 'selected="selected"' : '' }} value="1">{{ __('Apartment') }}
                </option>
                <option {{ request('type') == '2' ? 'selected="selected"' : '' }} value="2">{{ __('Villa') }}
                </option>
            </select>
        </div>
        <div class="py-3 self-center border-gray-500 border"></div>
