                ...
                @if($sections)
                    @foreach ($sections as $sec)
                        <ul class="ml-4">
                            ...
                            @php $lectures = Lecture::where([['course_id', $course->id],['sec_no' ,'=', $sec->section_no]])->get(); @endphp
                            ...
                            @if($lectures->count())
                                @foreach ($lectures as $lec)
                                    ...
                                    @if($video)
                                        <li class="mt-2 py-2 pl-3 @if($video->id === $media->id) bg-static-website @endif"> 
                                            <section class="d-flex justify-content-between">
                                            <a class="text-capitalize d-block"
                                                href="{{route('video-page', ['slug' => $course->slug, 'video' => explode('/',$video->lec_name)[1]])}}"> 
                                                <i class="fa fa-play mr-2" aria-hidden="true"></i>{{ reduceCharIfAv($lec->lec_name ?? '',40) }} 
                                            </a>                                    
            ...
            <div class="col-md-9">
                ...
                @if($next_media)
                    <div class="d-flex justify-content-end my-2">
                        <a href="{{route('video-page' , ['slug' => $course->slug, 'video' => explode('/',$next_media->lec_name)[1]])}}" class="btn btn-lg btn-website"> Next </a>
                    </div>
                @endif
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="pl-3 mt-2">
                                        ...
                                        <div class="my-2"> <a href="{{route('user-course',['slug' => $course->slug])}}" class="btn btn-website"> Course Link </a> </div>                       
                                    </div>
                                </div>
                            </div>
                    </div>
                ...
                <ul class="nav nav-pills" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <a class="nav-link active" id="home-tab" data-toggle="tab" href="#public" role="tab" aria-controls="public" aria-selected="true">Public Announcement</a>
                    </li>                   
                </ul>
                ...
                @if($extra_vid)
                    <div class="my-5">
                        <div class="container">
                            ...
                            <video  controls class="w-100" oncontextmenu="return false;">                                  
                                <source src="{{'https://lyskills-by-nouman.s3.ap-southeast-1.amazonaws.com/'}}{{$extra_vid->lec_path}}" type="{{$extra_vid->f_mimetype ?? '' }}">                    
                                    Your browser does not support the video tag. Please choose latest Google Chrome, Firefox , Opera Browser
                            </video>
                        </div>
                    </div>
