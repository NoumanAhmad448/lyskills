        ...
        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('messages.land_title'),
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('messages.land_des'),
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('messages.location_desc'),
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('messages.size_desc'),
            ...
            @include(config('files.forms') . 'col', [
                ...
                config('vars.prop') => [
                    ...
                    config('vars.label') => __('messages.city_desc'),
            ...
            @if (config('setting.en_land_reg_file'))
                @include(config('files.forms') . 'col', [
                    ...
                    config('vars.prop') => [
                        ...
                        'include_star' => false,
                        config('vars.label') => __('messages.file_upload_desc'),
