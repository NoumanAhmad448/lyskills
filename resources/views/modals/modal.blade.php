...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="update-coupon-form"
                        ...
                        <div class="row create_btn_row">
                            <section class="c_con mt-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="modal_coupon_no" placeholder="Coupon"
                                        name="coupon_no">
                                    <small class="form-text text-muted">write any specific word of your choice and share
                                        it with others
                                ...
                                <div class="row my-2">
                                    <div class="col">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="modal_is_free"
                                                name="is_free">
                                ...
                                <div class="form-group" id="modal_set_free">
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            <input type="text" class="form-control date-picker" id="modal_date_time"
                                                name="date_time" autocomplete="off">
                                        </div>
                                        <div class="col-3">
                                            <label for="no_of_coupons">Allowed Coupons?</label>
                                            <input type="number" class="form-control" id="modal_no_of_coupons"
                                                name="no_of_coupons">
                                        </div>
                                        <div class="col-5">
...
<div class="modal fade" data-backdrop="static" tabindex="-1" role="dialog" id="show-video">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <section id="modal-body">
                    <media-player src="" id="video-source" aspect-ratio="16/9">
                        <media-outlet>
