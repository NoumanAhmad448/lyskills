        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <ul class="nav flex-column d-none d-md-block border-right" id="side_menu">
                    <li class="nav-item">
                        <a class="nav-link text-dark " id="users" href="{{ route('a_users') }}"> <i
                                class="fa fa-users" aria-hidden="true"></i>
                            Users </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('a-asses') }}" id="asses"><i
                                class="fa fa-book" aria-hidden="true"></i>
                            Assignments </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('a_courses') }}" id="courses"> <i
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('course-enrollment') }}" id="enrollment"> <i
                                class="fa fa-book" aria-hidden="true"></i>
                            Enrollments </a>
                    </li>
                    <hr />
                    ...
                    @endif
                    <li class="nav-item">
                        <div class="nav-link text-dark cursor_pointer" id="a_setting"> <i class="fa fa-cog"
                                aria-hidden="true"></i>
                            Setting
                        </div>
                        <ul class="list-unstyled ml-3 d-none s_sub_menu">
                            <hr />
                            <li class="nav-item">
                                <a class="nav-link text-dark " href="{{ route('admin_g_setting') }}"
                                    id="a_g_setting">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-dark " href="{{ route('admin_lms_setting') }}"
                                    id="a_lms_setting">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-dark " href="{{ route('a_share_payment') }}"
                                    id="a_share_payment">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-dark " href="{{ route('a_payment_gateways') }}"
                                    id="a_payment_gateways">
                                    <i class="fa fa-university" aria-hidden="true"></i>
                                    Payment Gateways
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('a_offline_payment_gateways') }}"
                            id="a_offline_payment_gateways">
